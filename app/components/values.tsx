      ...
      <div className="flex flex-col lg:flex-row justify-center w-full m-5 flex-wrap items-center lg:items-start">
        ...
        >
          ...
          <div className="w-1/2 p-4">
            ...
            <p className="mb-3 text-sm italic text-black">
        ...
        <div className="bg-[#F2EEE9] rounded-xl shadow-lg group relative cursor-pointer w-full md:w-2/3 lg:w-1/3 h-60 m-4 items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 flex flex-row">
          <div className="flex flex-col justify-center items-center w-1/2">
            <Image
              src={mission}
              alt="microlearning"
        ...
        >
          ...
          <div className="w-1/2 p-4">
            ...
            <p className="mb-0 text-sm italic text-black text-center">
